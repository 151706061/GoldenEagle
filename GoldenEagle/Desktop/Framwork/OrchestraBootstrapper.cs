// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GoldenEagle.Desktop.FramworkBootstrapper.cs" company="GoldenEagle.Desktop.Framwork development team">
...
using GoldenEagle.Desktop.Framwork.Modules;
...
namespace GoldenEagle.Desktop.Framwork
{
    ...
    public class OrchestraBootstrapper : BootstrapperBase<MainWindow>
    {
        ...
        public OrchestraBootstrapper(bool createAboutRibbon = true)
        {
            ...
            {
                Source = new Uri("pack://application:,,,/Fluent;Component/Themes/Office2010/Black.xaml", UriKind.RelativeOrAbsolute)
            });
            application.Resources.MergedDictionaries.Add(new ResourceDictionary
            {
